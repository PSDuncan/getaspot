      ...
      <div className="container py-12 md:py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/auth/register?type=agent" className="text-muted-foreground hover:text-foreground">
                  Join as Agent
                </Link>
              </li>
              <li>
                <Link href="/auth/register?type=agency" className="text-muted-foreground hover:text-foreground">
                  Register Agency
                </Link>
              </li>
              <li>
                <Link href="/auth/register?type=seller" className="text-muted-foreground hover:text-foreground">
                  List Your Property
                </Link>
              </li>
              <li>
