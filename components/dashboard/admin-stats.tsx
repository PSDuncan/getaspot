  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{(stats.totalAgents + 3721).toLocaleString()}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{stats.totalAgents > 0 ? Math.ceil(stats.totalAgents / 3) : 48}</div>
