            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  The information provided on GetASpot is for general informational purposes only. While we strive to
                  keep the information accurate and up-to-date, we make no representations or warranties of any kind,
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Any calculations, estimates, or projections provided on our platform (such as mortgage calculations)
                  are for illustrative purposes only. Actual costs, payments, and terms may vary based on individual
