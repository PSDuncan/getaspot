          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                GetASpot was founded in 2024 with a simple vision: to create the best property platform in South Africa.
                We saw that existing platforms were slow, cluttered, and didn't put users first. So we built something
                better.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
