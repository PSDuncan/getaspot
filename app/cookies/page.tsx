        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                These cookies remember your preferences and choices (such as your language or region) to provide a more
                personalized experience.
              </p>

              <h3 className="text-xl font-semibold mb-2">Targeting/Advertising Cookies</h3>
              <p className="text-muted-foreground leading-relaxed">
                These cookies are used to deliver advertisements that are relevant to you. They also limit the number of
                times you see an advertisement and help measure the effectiveness of advertising campaigns.
              </p>
            </section>
